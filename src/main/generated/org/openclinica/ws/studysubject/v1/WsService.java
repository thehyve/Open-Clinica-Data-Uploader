 ...
 * 2016-06-13T12:21:40.426+02:00
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "wsService", 
                  wsdlLocation = "src/main/wsdl/studySubjectWsdl.wsdl",
                  targetNamespace = "http://openclinica.org/ws/studySubject/v1") 
public class WsService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://openclinica.org/ws/studySubject/v1", "wsService");
    public final static QName WsSoap11 = new QName("http://openclinica.org/ws/studySubject/v1", "wsSoap11");
    static {
        URL url = null;
        try {
            url = new URL("src/main/wsdl/studySubjectWsdl.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/wsdl/studySubjectWsdl.wsdl");
        }
        WSDL_LOCATION = url;
    }
